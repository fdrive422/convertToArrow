...
<body id="body">
    ...
    <p onmouseover="mouseOverFunction(this)">
        ...
        We can click anywhere in this paragraph tag and it will change the background color to whatever is in this input: <input id="color_click" type="text"/>.
    </p>
    <script>
        ...
        document.getElementById("hover-this").onmouseout = () => setBackgroundColorById("paragraph", "white");
        ...
        const mouseOverFunction = (el) => {
            const colorClick = getValueFromId("color_click")
            console.log(colorClick);
            el.style = "background-color: " + colorClick;
        }
    </script>
</body>
</html>